...
* Privacy Mode (HD): an address that received a partial payment for an order that was later cancelled is now retired properly, instead of being re-checked on every background run indefinitely
