...
* Privacy Mode (HD): before auto-cancelling an unpaid order whose time has run out, the plugin now does a final balance check on the payment address; if a payment has landed in the meantime the order is kept and completed rather than cancelled
